...
func (n Object) Set(key string, value any) {
	n[key] = value
}

func (n Object) Get(key string) any {
	return n[key]
}
...
func (n Object) GetFloat64(key string) float64 {
...
func (n Object) SetDefault(key string, defaultValue any) {
	if _, ok := n[key]; !ok {
		n[key] = defaultValue
	}
}
